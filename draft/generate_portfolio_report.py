...
# Estrutura esperada no seu computador:
# - código/script: C:/Users/USER/Documents/Pessoal/ProjetosPessoais/portfolio-optimization-engine/draft
# - CSVs de entrada e outputs: C:/Users/USER/Documents/Pessoal/ProjetosPessoais/portfolio-optimization-engine/data
DEFAULT_DRAFT_DIR = Path(r"C:/Users/USER/Documents/Pessoal/ProjetosPessoais/portfolio-optimization-engine/draft")
DEFAULT_DATA_DIR = Path(r"C:/Users/USER/Documents/Pessoal/ProjetosPessoais/portfolio-optimization-engine/data")

DRAFT_DIR = Path(os.getenv("PORTFOLIO_REPORT_DRAFT_DIR", str(DEFAULT_DRAFT_DIR))).expanduser()
DATA_DIR = Path(os.getenv("PORTFOLIO_REPORT_DATA_DIR", str(DEFAULT_DATA_DIR))).expanduser()
OUTPUT_DIR = DATA_DIR / "report_output"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

OPTIMAL_ALLOCATION_PATH = DATA_DIR / "optimal_allocation.csv"
SELECTED_TITLES_PATH = DATA_DIR / "selected10titles.csv"
SCREENED_STOCKS_PATH = DATA_DIR / "screened_stocks.csv"
SCREENED_FIIS_PATH = DATA_DIR / "screened_fiis.csv"
HISTORICAL_PRICES_PATH = DATA_DIR / "historical_prices.csv"
PORTFOLIO_RETURNS_PATH = DATA_DIR / "portfolio_returns_selected10.csv"

PDF_NAME = "relatorio_carteira_recomendada.pdf"
JSON_NAME = "web_research_cache.json"

# Use cache to avoid paying for the same research every run.
USE_CACHE = True
FORCE_REFRESH = False
...
def build_performance_summary(data: Dict[str, pd.DataFrame]) -> Dict[str, Any]:
    ...
    merged["cdi_return"] = merged["cdi_return"].fillna(method="ffill")
